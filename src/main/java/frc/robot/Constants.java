...
public final class Constants {
    ...
    // Hard-coded speeds
    public static final double RAISE_CLIMB_SPEED = 0.5;
    public static final double LOWER_CLIMB_SPEED = -0.5;
    public static final double INTAKE_SPEED = 0.5;
    public static final double OUTTAKE_SPEED = -1.0;
    public static final double RAISE_ARM_SPEED = 0.1;
    public static final double LOWER_ARM_SPEED = -0.1;
